...
/// @notice Minimal ERC4626-style tokenized Vault implementation for native tokens.
/// @author SolDAO (https://github.com/Sol-DAO/solbase/blob/main/src/mixins/NativeERC4626.sol)
/// @author Modified from Solmate (https://github.com/transmissions11/solmate/blob/main/src/mixins/ERC4626.sol)
abstract contract NativeERC4626 is ERC20Permit {
    ...
    function deposit(uint256 assets, address receiver) public payable virtual returns (uint256 shares) {
        ...
        if (msg.value != assets) revert BadMsgValue();
